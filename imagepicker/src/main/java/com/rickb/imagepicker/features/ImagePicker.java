...
import com.rickb.imagepicker.features.cameraonly.ImagePickerCameraOnly;
...
public abstract class ImagePicker {
    ...
    /**
     * @param megaBytes Amount of MB's that can be selected in total.
     * @return This ImagePicker instance
     */
    public ImagePicker totalSizeLimit(double megaBytes) {
        config.totalSizeLimit(megaBytes);
        return this;
    }
